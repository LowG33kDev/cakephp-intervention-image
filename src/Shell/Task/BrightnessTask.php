 ...
 *
 */
class BrightnessTask extends InterventionImageTask
{
    ...
    public function getOptionParser()
    {
        ...
        $parser->description(
            __d('CakeInterventionImage', 'Changes the brightness of the current image by the given <bold>level</bold>.'.
                                    ' Use values between -100 for min. brightness 0 for no change and +100 for max. brightness.')
        );
        $parser->addArgument('level', [
            'help' => __d('CakeInterventionImage', 'Level of brightness change applied to the current image. Use values between -100 and +100.'),
            'short' => 'l'
        ]);
        return $parser;
    }
